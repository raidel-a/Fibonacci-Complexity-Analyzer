...
public class ExecutionInfo {
    ...
    public ExecutionInfo(Map<String, Integer> fibMap, 
        ...
        totalMethodCalls = 0;
        for (Integer count : fibMap.values()) {
    ...
    public void displayInfo(){
        ...
        // use the keySet variable to loop through all the keys to output the following
        // hint use this
        //System.out.printf("%-20s %-5d \t %-10.3f\n" , key +":" ,fibMap.get(key), (fibMap.get(key)/ totalMethodCalls));
        // YOUR CODE HERE

        for (String key : keySet) {
            System.out.printf("%-20s %-8d \t %-10.3f\n", key + ":", fibMap.get(key), (double) fibMap.get(key) / totalMethodCalls);
        }
